/*
Dato: 27.09.2016 | Grunnleggende Programmering(IMT1032)
Anders Isaksen | stud.nr: 997585 | klasse: 16HBIDATT

Program som leser inn verdier for 3 brøker. Brukeren kan så veleg hva slags
operasjon(+,-,*,/) som skal utføres på brøkene. Svaret printes som en ny brøk
*/
#include <iostream>
using namespace std;
...
int main() {
	...
	for (int i = 0; i < 3; i++) {       //ask user to enter fraction numerator
		...
		} while (frac[i].denominator == 0);//ask again if input is 0
	}//end for loop
	 //print guidelines
